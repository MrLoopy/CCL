...
size_t size_full_graph_cons_byte = sizeof(unsigned int) * size_full_graph_cons;
...
int main (int argc, char ** argv){
  ...
  for(unsigned int ev = 0; ev < num_events ; ev++){
    ...
    ev_in_full_graph_cons.push_back(new unsigned int[size_full_graph_cons]);
