...
extern "C" {
  ...
  void CCL(
    ...
    #pragma HLS INTERFACE m_axi port = out_components     bundle=gmem19
    ...
    sub_core(io_graph_3, io_graph_cons_3, out_3, ctrl_3, component_3, processed_3, (num_nodes * 3 / factor) - ((num_nodes * 3 / factor) % 64), (num_nodes * 4 / factor) - ((num_nodes * 4 / factor) % 64));
    ...
    // compute_core(io_graph_0, io_graph_cons_0, num_nodes, outStream_components, control_stream);
